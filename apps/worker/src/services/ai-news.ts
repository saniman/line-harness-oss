...
[SUMMARY]
先週全体を通じたインサイト1〜2文。最後の1文は「私たちが引き続きAI活用を自分ごととしてキャッチアップしていくことが大切」という趣旨を自然な言葉で添える。「WALOVERとしては」等の自社宣伝的な表現は使わない。80字以内。
...
export function buildAiNewsFlexMessage(summary: string, liffUrl = ''): object {
  ...
  return {
    type: 'flex',
    altText: 'AI週次ニュース ─ 先週のAIハイライトをお届けします',
    contents: {
      type: 'bubble',
      size: 'giga',
      header: {
        ...
        contents: [
          {
            ...
            layout: 'horizontal',
            contents: [
              { type: 'text', text: '🤖 先週のAIニュース', color: '#ffffff', weight: 'bold', size: 'md', flex: 1 },
          ...
          },
          {
            ...
            cornerRadius: '8px',
            contents: [
              { type: 'text', text: '💡 先週のまとめ', color: '#f0c040', size: 'xs', weight: 'bold' },
              {
                type: 'text',
                text: parsed.summary,
                color: '#e6edf3',
